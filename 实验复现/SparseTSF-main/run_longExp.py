...
def main():
    ...
    # GPU
    parser.add_argument('--use_gpu', type=bool, default=False, help='use gpu')  # 设置为 False
    parser.add_argument('--gpu', type=int, default=0, help='gpu')  # 这个参数可以保留，但不使用
    parser.add_argument('--use_multi_gpu', type=int, help='use multiple gpus', default=0)  # 移除这个参数
    parser.add_argument('--devices', type=str, default='0', help='device ids of multile gpus')  # 可以保留为 '0'
